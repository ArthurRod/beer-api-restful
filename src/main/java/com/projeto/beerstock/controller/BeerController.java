...
import com.projeto.beerstock.service.BeerService;
...
public class BeerController implements BeerControllerDocs {
    ...
    public BeerDTO decrement(@PathVariable Long id, @RequestBody @Valid QuantityDTO quantityDTO) throws BeerNotFoundException, BeerStockEndsException {
